...
app.get("/", (_req, res) => res.send('Engine running. Vendor page: /vendor.html?email=ARTIST_EMAIL'));

setInterval(sweep, SWEEP_SECONDS * 1000);
app.listen(PORT, () => console.log(`claim engine on http://localhost:${PORT}  (sweep every ${SWEEP_SECONDS}s)`));
